...
exports.booking = (req, res, next) => {
    ...
    AgentData.fetchByName(agent).then(result => {
            ...
            data = {
                ...
                pickupdate: agentdata.bus[tid + ""].schedule[id + ""].start_date,
                pickuptime: agentdata.bus[tid + ""].schedule[id + ""].start_time,
                dropdate: agentdata.bus[tid + ""].schedule[id + ""].end_date,
                droptime: agentdata.bus[tid + ""].schedule[id + ""].end_time,
                seat: seat,
                price: price
            }
